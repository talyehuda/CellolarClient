...
namespace Common.Model
{
    public class Client
    {
        public Client(int id, int clientIdNumber, string name, string lastName, int clientTypeId, ClientType clientType, string address, string contactNameber, int callsToCenter, bool deleted)
        {
            Id = id;
